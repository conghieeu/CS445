...
public partial class @GameActionInput: IInputActionCollection2, IDisposable
{
    ...
    ~@GameActionInput()
    {
        Debug.Assert(!m_Player.enabled, "This will cause a leak and performance issues, GameActionInput.Player.Disable() has not been called.");
        Debug.Assert(!m_UI.enabled, "This will cause a leak and performance issues, GameActionInput.UI.Disable() has not been called.");
    }
